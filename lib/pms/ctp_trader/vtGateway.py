...
class VtGateway(object):
    ...
    def onTick(self, tick):
        ...
        event1.dict_['database'] = tick
        self.eventEngine.put(event1)
        
        # 特定合约代码的事件
        event2 = Event(type_=EVENT_TICK+tick.vtSymbol)
        event2.dict_['database'] = tick
    ...
    def onTrade(self, trade):
        ...
        event1.dict_['database'] = trade
        self.eventEngine.put(event1)
        
        # 特定合约的成交事件
        event2 = Event(type_=EVENT_TRADE+trade.vtSymbol)
        event2.dict_['database'] = trade
        self.eventEngine.put(event2)        
    ...
    def onOrder(self, order):
        ...
        event1.dict_['database'] = order
        self.eventEngine.put(event1)
        
        # 特定订单编号的事件
        event2 = Event(type_=EVENT_ORDER+order.vtOrderID)
        event2.dict_['database'] = order
        self.eventEngine.put(event2)
    ...
    def onPosition(self, position):
        ...
        event1.dict_['database'] = position
        self.eventEngine.put(event1)
        
        # 特定合约代码的事件
        event2 = Event(type_=EVENT_POSITION+position.vtSymbol)
        event2.dict_['database'] = position
        self.eventEngine.put(event2)
    ...
    def onAccount(self, account):
        ...
        event1.dict_['database'] = account
        self.eventEngine.put(event1)
        
        # 特定合约代码的事件
        event2 = Event(type_=EVENT_ACCOUNT+account.vtAccountID)
        event2.dict_['database'] = account
        self.eventEngine.put(event2)
    ...
    def onContract(self, contract):
        ...
        event1.dict_['database'] = contract
        self.eventEngine.put(event1)        
