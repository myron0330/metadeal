...
from trader.ctp_trader.vtGateway import *
from trader.ctp_trader.utils import loadMongoSetting

from cta_algo.cta_engine import CtaEngine
from data_recorder.data_record_engine import DataRecordEngine
from risk_manager.risk_manager_engine import RiskManagerEngine
...
class Scheduler(object):
    ...
    def initGateway(self):
        ...
        # 创建我们想要接入的接口对象
        from ctp_gateway.ctpGateway import CtpGateway
...
class DataEngine(object):
    """数据引擎"""
    contractFileName = 'contract_data'
