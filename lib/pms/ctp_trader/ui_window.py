...
from trader.ctp_trader.cta_algo.ui_widget_cta import CtaEngineManager
from trader.ctp_trader.data_recorder.ui_widget_data_record import DrEngineManager
from trader.ctp_trader.risk_manager.ui_widget_risk_manager import RmEngineManager
from trader.ctp_trader.ui_widget import *
...
class MainWindow(QtGui.QMainWindow):
    ...
    def saveWindowSettings(self, settingName):
        """保存窗口设置"""
        settings = QtCore.QSettings('ctp_trader', settingName)
